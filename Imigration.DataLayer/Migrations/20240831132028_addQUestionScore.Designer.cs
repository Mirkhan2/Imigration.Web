...
namespace Imigration.DataLayer.Migrations
{
    ...
    [Migration("20240831132028_addQUestionScore")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Imigration.Domains.Entities.Questions.SelectQuestionTag", b =>
                {
                    b.HasOne("Imigration.Domains.Entities.Questions.Question", null)
                        .WithMany("SelectQuestionTags")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Imigration.Domains.Entities.Tags.Tag", null)
                        .WithMany("SelectQuestionTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
